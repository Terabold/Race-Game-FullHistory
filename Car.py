...
class Car(pygame.sprite.Sprite):
    def __init__(self) -> None:
        ...
        self.drift_friction = 0.84  # How quickly drift momentum decays
        self.drift_factor = 0.1    # How much turning affects drift

        # Collision recovery attributes
        self.recovery_bounce = 0.3  # How much the car bounces off walls
        self.recovery_slowdown = 0.5 # How much to slow down on collision
        self.recovery_straighten = 15  # How much to straighten car on collision
    ...
    def handle_finishline_collision(self):
        # More gradual bounce off finish line
        self.velocity *= -0.8
        self.drift_momentum *= 0.5  # Reduce drift more gradually
        
        # Add slight sideways movement to help prevent getting stuck
        drift_radians = math.radians(self.angle + 90)
        self.x += math.sin(drift_radians) * 2
        self.y += math.cos(drift_radians) * 2
